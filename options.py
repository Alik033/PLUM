...
parser.add_argument('--data_path', default='/workspace/arijit_pg/Alik/Dataset/LSUI/train/') ## Dataset path

parser.add_argument('--checkpoints_dir', default='./ckpts_LSUI_r1_g15_b2/')
...
parser.add_argument('--lambda_ssim', type=float, default=0.6)
...
# parser.add_argument('--testing_dir_inp', default="/workspace/arijit/alik/Dataset/U45/")
parser.add_argument('--testing_dir_inp', default="/workspace/arijit_pg/Alik/Dataset/LSUI/test/input/")
parser.add_argument('--testing_dir_gt', default="/workspace/arijit_pg/Alik/Dataset/LSUI/test/GT/")
# parser.add_argument('--testing_dir_inp', default="./low/")
# parser.add_argument('--testing_dir_gt', default="./low/")
